		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#CompanhiasAereas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CompanhiasAereas-display": {
								"semanticObject": "CompanhiasAereas",
								"action": "display",
								"description": "Formação Talentos 2021",
								"title": "Companhias Aéreas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=numen.talentos.ztlnt2021001",
									"url": sap.ui.require.toUrl("numen/talentos/ztlnt2021001")
								}
							}
						}
					}
