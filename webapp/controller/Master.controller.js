sap.ui.define([
    ...
    return BaseController.extend("numen.talentos.ztlnt2021001.controller.Master", {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "numen.talentos.ztlnt2021001.view.ViewSettingsDialog",
                    controller: this
        ...
        onBtnCreatePress: function (oEvent) {
            ...
            if (!this.oDialogEditCompany) {
                ...
                this.oDialogEditCompany = Fragment.load({
                    id: this.getView().getId(),
                    name: "numen.talentos.ztlnt2021001.view.EditCompany",
                    controller: this
                }).then(function (oDialog) {
                    // connect dialog to the root view of this component (models, lifecycle)
                    this.getView().addDependent(oDialog);
